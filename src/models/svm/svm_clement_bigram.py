...
# %%
util.visualize_confusion_matrix(base_model,test_X, test_Y,"svm_big_base_clement_confusion_matrix")
...
# %%
util.plot_learning_curve(base_model, "svm_big_base_clement_learning_curve", train_X,train_Y, cv=KFold(5), n_jobs=4)
...
# %%
util.visualize_confusion_matrix(tfidf_model,test_X, test_Y,"svm_big_tfidf_clement_confusion_matrix")


# %%
tfidf_cv_results = cross_validate(tfidf_model, train_X, train_Y, cv=KFold(5))
util.plot_cv_score(tfidf_cv_results,title="svm_big_tfidf_clement_cv_score_bar")


# %%
util.plot_learning_curve(tfidf_model, "svm_big_tfidf_clement_learning_curve", train_X,train_Y, cv=KFold(5), n_jobs=4)


# %%
util.plot_word_cloud(tfidf_model,"svm_big_tfidf_clement_word_cloud")
