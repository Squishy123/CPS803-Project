...
# %%
util.visualize_confusion_matrix(tfidf_model,test_X, test_Y,"log_reg_uni_tfidf_comp_confusion_matrix")


# %%
tfidf_cv_results = cross_validate(tfidf_model, train_X, train_Y, cv=KFold(5))
util.plot_cv_score(tfidf_cv_results,title="log_reg_uni_tfidf_comp_cv_score_bar")


# %%
util.plot_learning_curve(tfidf_model, "log_reg_uni_tfidf_comp_learning_curve", train_X,train_Y, cv=KFold(5), n_jobs=4)
