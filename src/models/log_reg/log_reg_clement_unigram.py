...
# %%
util.visualize_confusion_matrix(base_model,test_X, test_Y,"naive_bayes_uni_tfidf_clement_confusion_matrix")


# %%
tfidf_cv_results = cross_validate(base_model, train_X, train_Y, cv=KFold(5))
util.plot_cv_score(base_cv_results,title="naive_bayes_uni_tfidf_clement_cv_score_bar")


# %%
util.plot_learning_curve(base_model, "naive_bayes_uni_tfidf_clement_learning_curve", train_X,train_Y, cv=KFold(5), n_jobs=4)
