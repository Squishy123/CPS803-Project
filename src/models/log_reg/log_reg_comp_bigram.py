...
# %%
util.plot_learning_curve(base_model, "log_reg_big_base_comp_learning_curve", train_X,train_Y, cv=KFold(5), n_jobs=4)
...
# %%
util.plot_word_cloud(tfidf_model,"log_reg_big_tfidf_comp_word_cloud")
